...
public class CameraViewController: UIViewController {
    ...
    let cameraButton : UIButton = {
        ...
        button.setImage(UIImage(named: "click icon.png",
    ...
    let closeButton : UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setImage(UIImage(named: "close png.png",
            inBundle: CameraGlobals.shared.bundle,
            compatibleWithTraitCollection: nil),
                        forState: .Normal)
        return button
...
//    }()
    ...
    let libraryButton : UIButton = {
        let button = UIButton(frame: CGRect(x: 0, y: 0, width: 40, height: 40))
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setImage(UIImage(named: "gallery Icon.png",
            inBundle: CameraGlobals.shared.bundle,
            compatibleWithTraitCollection: nil),
                        forState: .Normal)
        return button
    ...
    let flashButton : UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setImage(UIImage(named: "flashYellow.png",
            inBundle: CameraGlobals.shared.bundle,
            compatibleWithTraitCollection: nil),
                        forState: .Normal)
        return button
...
//        configSwapButtonGravityConstraint(portrait)
        ...
        let padding : CGFloat = portrait ? 0.0 : -0.0
