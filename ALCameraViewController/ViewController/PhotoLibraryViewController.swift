...
public class PhotoLibraryViewController: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        let buttonImage = UIImage(named: "Back icon.png", inBundle: CameraGlobals.shared.bundle, compatibleWithTraitCollection: nil)?.imageWithRenderingMode(UIImageRenderingMode.AlwaysOriginal)
