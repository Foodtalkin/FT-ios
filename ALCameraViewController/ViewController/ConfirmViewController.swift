...
//    weak var confirmButton: UIButton!
    ...
    public override func viewDidLoad() {
        ...
        btnRetake.frame = CGRectMake(10, UIScreen.mainScreen().bounds.size.height - 50, 64, 46)
        btnRetake.addTarget(self, action: #selector(ConfirmViewController.cancel), forControlEvents: UIControlEvents.TouchUpInside)
        btnRetake.setTitle("Retake", forState: UIControlState.Normal)
        btnRetake.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
        self.view.addSubview(btnRetake)
        
        let btnUse = UIButton()
        btnUse.frame = CGRectMake(UIScreen.mainScreen().bounds.size.width - 74, UIScreen.mainScreen().bounds.size.height - 50, 64, 46)
        btnUse.addTarget(self, action: #selector(ConfirmViewController.confirmPhoto), forControlEvents: UIControlEvents.TouchUpInside)
        btnUse.setTitle("Use", forState: UIControlState.Normal)
        btnUse.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
